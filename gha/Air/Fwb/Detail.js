...
class Detail extends Component
{
  render() {
    ...
    return <React.Fragment>
      <PopupHeader>
        <h6>{trans('AWB')} {numeral(this.models('props.data.data.prefix')).format("000")} {this.models('props.data.data.code', '').substr(0,4)} {this.models('props.data.data.code', '').substr(4,4)}</h6>
      </PopupHeader>
      <PopupBody>
        <div className="font-weight-bold justify-content-around row">
			    <div className="row h-100">
            <div className="border-left border-right h-100 px-2">{this.models('props.data.data.cardits.0.departure.airport.iata')}</div>
            <div className="px-2">{this.models('props.data.data.cardits.0.provenance.endpoint.owner.airport.gha.name')}</div>
          </div>
			    <div>{trans('AWB')} : {numeral(this.models('props.data.data.prefix')).format("000")} {this.models('props.data.data.code', '').substr(0,4)} {this.models('props.data.data.code', '').substr(4,4)}</div>
          ...
          <tbody>
            <tr className="bg-light text-center">
              ...
              <td colSpan="2" rowSpan="3" style={{width:'25%'}} className="text-wrap">
                <h3>{this.models('props.data.data.cardits.0.provenance.owner.airport.gha.name')}</h3>
                //
              </td>
            </tr>
            <tr>
  <td colSpan="2" className="border-bottom-0">{this.models('props.data.data.cardits.0.departure.organisation_name12')}</td>
              <td colSpan="4">
            ...
            <tr>
              <td colSpan="6" className="border-top-0 text-wrap">
                {this.models('props.data.data.cardits.0.departure.adresse.raw')}<br/>
                {this.models('props.data.data.cardits.0.departure.adresse.ville.nom')}<br/>
                {this.models('props.data.data.cardits.0.departure.adresse.ville.cp')} {this.models('props.data.data.cardits.0.departure.adresse.raw2')}<br/>
                {this.models('props.data.data.cardits.0.departure.adresse.ville.country.nom')}
              </td>
            </tr>
            <tr className="bg-light text-center">
            ...
            <tr>
              ...
              {this.models('props.data.data.cardits.0.destination.organisation_name12')}
              </td>
              <td colSpan="4"></td>
            </tr>
            <tr>
              <td colSpan="6" className="border-top-0 text-wrap">
                {this.models('props.data.data.cardits.0.destination.adresse.raw')}<br/>
                {this.models('props.data.data.cardits.0.destination.adresse.ville.nom')}<br/>
                {this.models('props.data.data.cardits.0.destination.adresse.ville.cp')} {this.models('props.data.data.cardits.0.destination.adresse.raw2')}<br/>
                {this.models('props.data.data.cardits.0.destination.adresse.ville.country.nom')}
              </td>
            </tr>
            <tr className="bg-light text-center">
            ...
            <tr>
              <td colSpan="6">
                <p>{this.models('props.data.data.cardits.0.departure.organisation_name12')}</p>
                <p>{this.models('props.data.data.cardits.0.departure.adresse.raw')}<br/>
                  {this.models('props.data.data.cardits.0.departure.adresse.ville.nom')}<br/>
                  {this.models('props.data.data.cardits.0.departure.adresse.ville.cp')} {this.models('props.data.data.cardits.0.departure.adresse.raw2')}<br/>
                  {this.models('props.data.data.cardits.0.departure.adresse.ville.country.nom')}</p>
              </td>
              <td colSpan="8" rowSpan="3">
                {this.models('props.data.data.cardits.0.departure.agent_code')}
              </td>
            </tr>
            <tr className="bg-light text-center">
              <td colSpan="2" className="p-0">
            ...
            <tr>
              <td colSpan="6">
                {this.models('props.data.data.cardits.0.departure.airport.ville.nom')}
              </td>
              <td colSpan="6">
            ...
            <tr>
              <td>
                {this.models('props.data.data.cardits.0.nsetup.handover_destination_location.iata')}
              </td>
              <td>
                {this.models('props.data.data.cardits.0.provenance.endpoint.owner.airport.gha.name')}
              </td>
              <td>
                {this.models('props.data.data.cardits.0.nsetup.transports', []).length>1?this.models('props.data.data.cardits.0.nsetup.transports.1.departure_location.iata'):''}
              </td>
              <td>
                {this.models('props.data.data.cardits.0.nsetup.transports', []).length>1?this.models('props.data.data.cardits.0.nsetup.transports.1.reference', '').substr(0,2):''}
              </td>
              <td>
                {this.models('props.data.data.cardits.0.nsetup.transports', []).length>1?this.models('props.data.data.cardits.0.nsetup.transports.2.departure_location.iata'):''}
              </td>
              <td>
                {this.models('props.data.data.cardits.0.nsetup.transports', []).length>1?this.models('props.data.data.cardits.0.nsetup.transports.2.reference', '').substr(0,2):''}
              </td>
              <td>
                {this.models('props.data.data.cardits.0.departure.currency.iso_code')}
              </td>
              <td></td>
              <td>X</td>
              <td></td>
            ...
            <tr>
              <td colSpan="2" className="text-wrap">
                {this.models('props.data.data.cardits.0.destination.airport.ville.nom')}
              </td>
              <td colSpan="2" className="text-wrap">
                {this.models('props.data.data.cardits.0.nsetup.transports.0.conveyence_reference')}
              </td>
              <td colSpan="2">
                {moment(this.models('props.data.data.cardits.0.nsetup.transports.0.departure_datetime_lt')).format('DD/MM/YYYY HH:mm')}
              </td>
              <td colSpan="6"></td>
            </tr>
            <tr className="bg-light text-center">
            ...
            <tr>
              <td colSpan="2" className="align-baseline">
                <p>POSTAL MAIL {this.models('props.data.data.cardits.0.nsetup.document_number')}</p>
                MAL
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colSpan="7" className="align-baseline">
                ...
                {moment(this.models('props.data.data.cardits.0.created_at')).format('DD/MM/YYYY')}
              </td>
      ...
      <PopupFooter>
        <a href={`/ltapdf?id=${this.models('props.data.data.id')}`} className="btn btn-primary" target="_blank">{trans('Télécharger')}</a>
      </PopupFooter>
    </React.Fragment>
  }
}
