      ...
      <div className="card">
        <div className="card-body">
          ...
          <div className="text-right">
            <a className="btn btn-orange" href={`/flightdoc?${qs.stringify({id:this.models('props.data.data.id'),format:'pdf'})}`} target="_blank"><i className="fa fa-file-pdf"></i> {trans('Télécharger')}</a>
          </div>
        </div>
      </div>
    </div>
