...
class List extends BaseList
{
    ...
    beforelist() {
        if(this.models('props.data.user.guard')=='manager')
            return <div className="d-flex justify-content-center">
                <label className="btn btn-primary mr-30" data-name="mld" data-dropzone-action="/upload_mld" data-any-file="true">{trans('Importer un MLD')}</label>
            </div>
        return null
    }
